...
tools. Our results show that {\tool} is able to fix {\bf XX\%} and
{\bf XX\%} more bugs than the best-performance DL-based baseline
models, in which several of them are context-dependent bugs. {\tool}
detected {\bf XX} unique bugs that all the other DL-based APR models
missed.
