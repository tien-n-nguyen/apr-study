...
tools. Our results show that {\tool} is able to fix 16.7\%--194.7\% more bugs than the compared DL-based baseline
models on Defects4J, in which several of them are context-dependent bugs. 
%{\tool} detected {\bf XX} unique bugs that all the other DL-based APR models missed.
