...
than any DL-based baselines}. Specifically, {\tool}
...
%
Moreover, {\tool} fixed 12 bugs that the best baseline CURE missed; and
CURE fixed 4 bugs that {\tool} missed. \tool fixed 3 bugs that all
the DL-based baselines missed.
