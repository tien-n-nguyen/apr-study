...
overlapping result between {\tool} and one baseline in two datasets.
...
\begin{figure}[t]
	\centering
	\includegraphics[width=3.3in]{graphs/example_3_v2.png}
        \vspace{-9pt}
...
transformation learning. In this example, \code{curIndex} was
