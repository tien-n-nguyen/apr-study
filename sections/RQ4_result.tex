...
{\em D.2.2. Can the better bug-fixing from {\tool}'s dual-task
  learning than the bug-fixing from the \code{Cascading} model be
  partially attributed to beter context learning?}


To answer D.2.2., we further analyzed {\bf 54} bugs that were fixed by
...
This indicates that {\em 1) better APR is partially due to better
  context learning CCL in dual-task learning} and {\em 2) one source
