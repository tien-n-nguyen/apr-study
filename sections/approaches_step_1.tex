...
Second, to train the contex learning model (\code{CCL}), we need the
...
transformation learning model (\code{CTL}), we need to identify the
...
To provide the compatible inputs for \code{CCL} and \code{CTL} models,
