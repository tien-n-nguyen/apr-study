...
In Figure~\ref{fig:cross-stitch}, for dual learning, we use the
...
depth. When making prediction, if one vector is close to zero, we
consider it as empty, and all of its children nodes are considered as
empty.
