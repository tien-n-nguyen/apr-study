...
from one buggy subtree in an Abstract Syntax Tree (AST) or a buggy
...
approaches have a clear separate representation for context in
APR~\cite{chen2018sequencer,icse20,cure-icse21,lutellier2020coconut}.
...
second layer designed to learn the bug-fixing
transformations. However, the cascading architecture from the
two layers create a confounding effect from the inaccuracy of the
learning of the context to the learning of the bug-fixing
transformations.
