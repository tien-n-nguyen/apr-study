...
{\em explicitly models the impact of context learning to fixing
  transformation learning} and vice versa. We
dedicates one model to learn
%the bug-fixing
code transformations (CTL) and another one to learn
%the corresponding surrounding
respective code contexts (CCL).
%
