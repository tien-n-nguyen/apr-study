...
We used the correct fixing locations for the models to perform the fixing and test cases for validation steps. 
We set a 5-hr limit for the validation step for all approaches. 
