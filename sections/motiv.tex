...
preceding code \code{getDataset} or the succeeding code
...
consists of two models. The first one, the \code{CCL} model, is
dedicated for learning code contexts, and the second one, the
\code{CTL} model, for learning bug-fixing code transformations.
...
representations.
%when we leverage the constraints of this duality in term of
