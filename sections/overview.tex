...
To build the context, we first collect the AST nodes that have {\em
  data and control dependencies with the buggy statement}. We then
take the subtree that covers all those nodes and use it as the context
